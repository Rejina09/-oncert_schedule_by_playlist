...
def test_len_playlist():
    ...
    playlist_url2 = "https://music.yandex.ru/users/mashademinova1/playlists/1005?utm_medium=copy_link"
...
def test_artists():
    ...
    artists2 = set(get_playlist_artists(playlist_url2, config.YANDEX_MUSIC_TOKEN, 1))
